...
- (void)allSelectButtonClick:(UIButton *)sender {
    if ([self.delegate respondsToSelector:@selector(bottomSelectClickWithBottomView:)]) {
        [self.delegate bottomSelectClickWithBottomView:self];
    }
}
