...
@implementation BBGoodBlockCell
...
- (void)selectButtonClick:(UIButton *)sender {
    if (self.cellDidClickSelectBlock) {
        self.cellDidClickSelectBlock();
    }
}
#pragma mark 改变商品数量
// plus
...
- (void)changeGoodsCount:(id)sender {
    if (self.cellChangeGoodNumBlock) {
        self.cellChangeGoodNumBlock(self.changeCountTxt.text);
    }
}
#pragma mark - setter
